...
It deduced from this Ingress object that traffic to `openshift-test` is intended to be secured by Let's Encrypt so it silently built a cert-manager Certificate object to represent that requirement.
